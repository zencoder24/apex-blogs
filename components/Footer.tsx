...
const Footer = () => {
  return (
    <footer className=" footer  w-full items-center bg-light-primary bg-gradient-to-br from-light-primary/0 to-light-secondary/75 p-2  dark:bg-dark-primary dark:from-dark-primary/0 dark:to-dark-secondary">
